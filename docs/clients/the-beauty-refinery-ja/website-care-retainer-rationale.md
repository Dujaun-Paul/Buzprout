...
## 1. One-time build vs ongoing care

**Build (project fee)** covers design, development, content setup, and launch. It ends when the site goes live.
...
- Checking that booking and deposit instructions still work end to end
- Responding when the Book button stops working
- Guarding against security issues in dependencies
- Monitoring that forms, contact links, and pages still behave correctly
...
**If you pay in cash:** hosting, domain renewal, database usage, backups, and professional care.

**If you pay in time:** you or your staff troubleshoot outages, chase down broken links, and figure out why bookings stopped.

**If you pay in opportunity:** stale prices on the site, a broken booking flow over a weekend, or customers who give up because the site looks outdated or does not work.
...
- Monitoring that the site loads and key pages work
- Security and dependency updates as needed
- Small bug fixes from normal use
- Checking the booking flow still works end to end
...
- Oversight of hosting, deployment, and database health
...
**Without care:** issues wait until someone is free; every fix becomes a rush quote; prices and policies go stale; security updates get skipped.

**With care:** there is a clear owner; small updates are expected; downtime and booking failures are treated as priority.
...
Stale prices or a broken booking flow directly affect revenue and trust. Care protects that.
...
**JMD $5,000/month is not charging for free hosting.** It is a small, predictable fee for ownership, updates, and reliability of a live business website after launch.
