...
export const MATURITY_STAGES: MaturityStage[] = [
  ...
  },
  {
    ...
    needs: ["Bookings", "Automation", "CRM basics", "Operational efficiency"],
  ...
  },
  {
    ...
    signals: [
      ...
      "You need custom software, integrations, or multi-location ops",
      "You want a long-term technical partner, not one-off projects",
    ],
    needs: ["Custom platforms", "API integrations", "Analytics", "Ongoing development"],
